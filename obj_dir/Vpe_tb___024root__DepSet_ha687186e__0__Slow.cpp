...
VL_ATTR_COLD void Vpe_tb___024root___ctor_var_reset(Vpe_tb___024root* vlSelf) {
    ...
    vlSelf->pe_tb__DOT__weight_in = VL_RAND_RESET_I(8);
    vlSelf->pe_tb__DOT__activation_in = VL_RAND_RESET_I(8);
    vlSelf->pe_tb__DOT__partial_sum_in = VL_RAND_RESET_I(32);
    vlSelf->pe_tb__DOT__flush_accum = VL_RAND_RESET_I(1);
    vlSelf->pe_tb__DOT__partial_sum_out = VL_RAND_RESET_I(32);
    vlSelf->pe_tb__DOT__instance1__DOT__temp = VL_RAND_RESET_I(16);
